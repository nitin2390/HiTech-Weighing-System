...
namespace HitechTMS
{
    public partial class frmMain : SecureBaseForm
    {
        ...
        {
            frmDateFiltersForReports _frmDateFiltersForReports 
                = new frmDateFiltersForReports(enumProductNormalPublicMulti.Normal,
                                                _nextFormPrincipal);
            _frmDateFiltersForReports.StartPosition = FormStartPosition.CenterParent;
            _frmDateFiltersForReports.ShowDialog();
        }
