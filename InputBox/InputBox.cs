...
namespace MsgBox
{
    public static class InputBox
    {
        ...
        public static DialogResult ShowDialog(string Message, string Title = "", Icon icon = Icon.Information, Buttons buttons = Buttons.Ok, Type type = Type.Nothing, string[] ListItems = null, bool ShowInTaskBar = false, Font FormFont = null)
        {
            ...
            panel.Size = new System.Drawing.Size(340, 110);
        ...
        private static PictureBox Picture(Icon icon)
        {
            ...
            picture.Size = new System.Drawing.Size(40,40);
            picture.Location = new System.Drawing.Point(20, 30);
            return picture;
        }
        ...
        private static Button[] Btns(Buttons button, Language lang = Language.English)
        {
            ...
            switch (button)
            {
                ...
                case Buttons.OkCancel:
                    OkButton.Location = new System.Drawing.Point(x-90, y);
                    returnButtons[0] = OkButton;

                    StornoButton.Location = new System.Drawing.Point(x, y);
                    returnButtons[1] = StornoButton;
                    break;

                case Buttons.YesNo:
                    AnoButton.Location = new System.Drawing.Point(x - 90, y);
                    returnButtons[0] = AnoButton;

                    NeButton.Location = new System.Drawing.Point(x, y);
                    returnButtons[1] = NeButton;
                    break;

                case Buttons.YesNoCancel:
                    AnoButton.Location = new System.Drawing.Point(x - 170, y);
                    returnButtons[0] = AnoButton;    

                    NeButton.Location = new System.Drawing.Point(x - 90, y);
                    returnButtons[1] = NeButton;
